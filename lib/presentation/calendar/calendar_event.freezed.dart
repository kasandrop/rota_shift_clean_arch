...
class __$rotaYearChangedCopyWithImpl<$Res> extends _$CalendarEventCopyWithImpl<$Res>
...
abstract class _rotaYearChanged implements CalendarEvent {
  const factory _rotaYearChanged({String rota, String year}) = _$_rotaYearChanged;
...
abstract class _$holidayUpdatedCopyWith<$Res> {
  ...
  $Res call({Option<Either<Failure, Map<DateTime, List<Holiday>>>> holidaysOption});
}

class __$holidayUpdatedCopyWithImpl<$Res> extends _$CalendarEventCopyWithImpl<$Res>
...
class _$_holidayUpdated implements _holidayUpdated {
  ...
  @override
  int get hashCode =>
      runtimeType.hashCode ^ const DeepCollectionEquality().hash(holidaysOption);
